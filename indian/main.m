...
%percent parçalama işlemidir %5 %10 için 100-5 değerini giriniz.

param.percent=90;
param.features=false;
%yüklenen dataset üzerinden eğitim ve test verileriniin ayrılması target
%matrislerinin yani sınıfların çıkarılması
